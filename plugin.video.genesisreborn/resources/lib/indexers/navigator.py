...
class navigator:
    def root(self):
        ...
        if not control.setting('lists.widget') == '0':
            self.addDirectoryItem('My Movies', 'mymovieNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
            self.addDirectoryItem('My TV Shows', 'mytvNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('People', 'moviePersons', 'people.png', 'DefaultMovies.png')
        #self.addDirectoryItem(32014, 'movieLanguages', 'languages.png', 'DefaultMovies.png')
        self.addDirectoryItem('Ratings', 'movieCertificates', 'certificates.png', 'DefaultMovies.png')
        self.addDirectoryItem('Most Populars', 'movies&url=popular', 'populars.png', 'DefaultMovies.png')
        self.addDirectoryItem('Highly Rated', 'movies&url=views', 'most-viewed.png', 'DefaultMovies.png')
        #self.addDirectoryItem(32020, 'movies&url=boxoffice', 'box-office.png', 'DefaultMovies.png')
        #self.addDirectoryItem('Most Voted', 'movies&url=tmdboscars', 'oscars.png', 'DefaultMovies.png')
        ...
        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem('My Movies', 'mymovieliteNavigator', 'mymovies.png', 'DefaultVideoPlaylists.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('Exclusive', 'tvshows&url=rating', 'populars.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Genres', 'tvGenres', 'genres.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Networks', 'tvNetworks', 'networks.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Languages', 'tvLanguages', 'trending.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Ratings', 'tvCertificates', 'certificates.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Trending', 'tvshows&url=trending', 'trending.png', 'DefaultRecentlyAddedEpisodes.png')
        self.addDirectoryItem('Most Popular', 'tvshows&url=popular', 'most-viewed.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Most Voted', 'tvshows&url=views', 'most-viewed.png', 'DefaultTVShows.png')
        self.addDirectoryItem('On TV Today', 'tvshows&url=airing', 'airing-today.png', 'DefaultTVShows.png')
        #self.addDirectoryItem('Returning Shows', 'tvshows&url=active', 'years.png', 'DefaultTVShows.png')
        self.addDirectoryItem('New Shows', 'tvshows&url=premiere', 'featured.png', 'DefaultTVShows.png')
        self.addDirectoryItem('TV Guide', 'calendar&url=added', 'airing-today.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
        self.addDirectoryItem('TV Calendar', 'calendars', 'networks.png', 'DefaultRecentlyAddedEpisodes.png')

        if lite == False:
            if not control.setting('lists.widget') == '0':
                self.addDirectoryItem('My TV Shows', 'mytvliteNavigator', 'airing-today.png', 'DefaultVideoPlaylists.png')

            self.addDirectoryItem('People Search', 'tvPerson', 'people-search.png', 'DefaultTVShows.png')
            self.addDirectoryItem('TV Show Search', 'tvSearch', 'search.png', 'DefaultTVShows.png')
